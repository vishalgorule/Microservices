...
public class ElasticDocumentController {
    ...
    public ElasticDocumentController(ElasticQueryServiceResponseModelAssembler elasticQueryServiceResponseModelAssembler, ElasticQueryClient<TwitterIndexModel> elasticQueryClient, ElasticQueryService queryService) {
    ...
    @PostAuthorize("hasPermission(returnObject, 'READ')")
    @PostMapping("/get-document-by-text-2")
    public @ResponseBody
    ResponseEntity<ElasticQueryServiceAnalyticsResponseModel> getDocumentByText2(@RequestBody @Valid ElasticQueryServiceRequestModel elasticQueryServiceRequestModel) {
        ElasticQueryServiceAnalyticsResponseModel response = elasticQueryService.getDocumentByText2(elasticQueryServiceRequestModel.getText());
