...
@ControllerAdvice
public class ElasticQueryClientErrorHandler {

    private static final Logger LOG = LoggerFactory.getLogger(ElasticQueryClientErrorHandler.class);
    ...
    public String handle(RuntimeException e, Model model) {
        ...
        model.addAttribute("elasticQueryWebClientRequestModel", ElasticQueryClientRequestModel.builder().build());
