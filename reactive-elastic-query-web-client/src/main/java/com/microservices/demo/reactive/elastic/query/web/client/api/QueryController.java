...
public class QueryController {
    ...
    public String queryByText(@Valid ElasticQueryClientRequestModel requestModel, Model model) {
        Flux<ElasticQueryClientResponseModel> responseModel = elasticQueryWebClient.getDataByText(requestModel);
